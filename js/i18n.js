...
(() => {
  ...
  const ru = {
    ...
    'about.how': `<strong>Как я работаю:</strong> полностью асинхронно. Вы пишете — я выкатываю, результат видите в собственных дашбордах. Без еженедельных статусов, без счетов за встречи.`,
    ...
    'process.2.body': `В течение двух рабочих дней получаете: что собираю, сколько стоит, сколько займет. Без почасовки и без расползания скоупа.`,
    'process.3.title': `Собрал, запустил, передал.`,
    'process.3.body': `Большинство магазинов выходят в бой за две-четыре недели. Вы согласовываете, я выкатываю. Тема, документация и полные права — ваши.`,
